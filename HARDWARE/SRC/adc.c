...
{ 
    ...
    ADC1_Handler.Init.ExternalTrigConv=ADC_SOFTWARE_START;       //SOFTWARE
    ADC1_Handler.Init.ExternalTrigConvEdge=ADC_EXTERNALTRIGCONVEDGE_NONE;//rising edge
...
u16 Get_ADC(void)
{
    ...
    ADC1_ChanConf.Channel=ADC_CHANNEL_13;                                   //通道
